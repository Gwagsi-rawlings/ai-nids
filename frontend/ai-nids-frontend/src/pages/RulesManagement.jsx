...
// ── Seed rule data ────────────────────────────────────────────────────────────
const SEED_RULES = [
  { id: "SID:1001", name: "SQL Injection UNION SELECT",       category: "WebAttack",  severity: "HIGH",     enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "80",  raw: 'alert tcp any any -> any 80 (msg:"SQL Injection UNION SELECT"; content:"UNION"; content:"SELECT"; nocase; classtype:web-application-attack; sid:1001; rev:1;)', hits: 248, created: "2026-03-22" },
  { id: "SID:1002", name: "Port Scan SYN Sweep",              category: "PortScan",   severity: "MEDIUM",   enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "any", raw: 'alert tcp any any -> any any (msg:"Port Scan SYN Sweep"; flags:S; threshold: type both, track by_src, count 20, seconds 60; classtype:network-scan; sid:1002; rev:1;)', hits: 1034, created: "2026-03-22" },
  { id: "SID:1003", name: "Ping Flood DoS",                   category: "DoS",        severity: "HIGH",     enabled: true,  protocol: "icmp",src: "any", srcPort: "any", dst: "any", dstPort: "any", raw: 'alert icmp any any -> any any (msg:"Ping Flood DoS"; threshold: type both, track by_src, count 100, seconds 1; classtype:attempted-dos; priority:1; sid:1003; rev:2;)', hits: 57, created: "2026-03-22" },
  { id: "SID:1004", name: "XSS Script Tag Attempt",           category: "WebAttack",  severity: "MEDIUM",   enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "80",  raw: 'alert tcp any any -> any 80 (msg:"XSS Script Tag Attempt"; content:"<script"; nocase; classtype:web-application-attack; sid:1004; rev:1;)', hits: 312, created: "2026-03-22" },
  { id: "SID:1005", name: "SSH Brute Force Attempt",          category: "BruteForce", severity: "CRITICAL", enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "22",  raw: 'alert tcp any any -> any 22 (msg:"SSH Brute Force Attempt"; flags:S; threshold: type both, track by_src, count 5, seconds 60; classtype:attempted-admin; priority:2; sid:1005; rev:1;)', hits: 891, created: "2026-03-22" },
  { id: "SID:1006", name: "FTP Brute Force Attempt",          category: "BruteForce", severity: "HIGH",     enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "21",  raw: 'alert tcp any any -> any 21 (msg:"FTP Brute Force Attempt"; flags:S; threshold: type both, track by_src, count 10, seconds 30; classtype:attempted-admin; sid:1006; rev:1;)', hits: 203, created: "2026-03-23" },
  { id: "SID:1007", name: "HTTP GET Flood DoS",               category: "DoS",        severity: "HIGH",     enabled: false, protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "80",  raw: 'alert tcp any any -> any 80 (msg:"HTTP GET Flood DoS"; content:"GET"; threshold: type both, track by_src, count 200, seconds 1; classtype:attempted-dos; sid:1007; rev:1;)', hits: 0,  created: "2026-03-23" },
  { id: "SID:1008", name: "DDoS LOIC HTTP Flood",             category: "DDoS",       severity: "CRITICAL", enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "80",  raw: 'alert tcp any any -> any 80 (msg:"DDoS LOIC HTTP Flood"; content:"GET"; threshold: type both, track by_src, count 500, seconds 1; classtype:attempted-dos; priority:1; sid:1008; rev:1;)', hits: 29, created: "2026-03-23" },
  { id: "SID:1009", name: "Botnet C2 Beacon Pattern",         category: "Botnet",     severity: "CRITICAL", enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "any", raw: 'alert tcp any any -> any any (msg:"Botnet C2 Beacon Pattern"; content:"CONNECT"; threshold: type both, track by_src, count 30, seconds 60; classtype:trojan-activity; priority:1; sid:1009; rev:1;)', hits: 14, created: "2026-03-24" },
  { id: "SID:1010", name: "SQL Blind Boolean Injection",      category: "WebAttack",  severity: "HIGH",     enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "80",  raw: 'alert tcp any any -> any 80 (msg:"SQL Blind Boolean Injection"; content:"OR 1=1"; nocase; classtype:web-application-attack; sid:1010; rev:1;)', hits: 178, created: "2026-03-24" },
  { id: "SID:1011", name: "ICMP Traceroute Sweep",            category: "PortScan",   severity: "LOW",      enabled: false, protocol: "icmp",src: "any", srcPort: "any", dst: "any", dstPort: "any", raw: 'alert icmp any any -> any any (msg:"ICMP Traceroute Sweep"; itype:11; threshold: type both, track by_src, count 10, seconds 5; classtype:network-scan; sid:1011; rev:1;)', hits: 0, created: "2026-03-25" },
  { id: "SID:1012", name: "XSS Event Handler Injection",      category: "WebAttack",  severity: "MEDIUM",   enabled: true,  protocol: "tcp", src: "any", srcPort: "any", dst: "any", dstPort: "80",  raw: 'alert tcp any any -> any 80 (msg:"XSS Event Handler Injection"; content:"onerror"; nocase; classtype:web-application-attack; sid:1012; rev:1;)', hits: 94, created: "2026-03-25" },
];
